...
/**
 * @file
 * Contains \Drupal\workflow\Entity\WorkflowStateStorage.
 */
...
/**
 * Storage handler for workflow_state   config entities.
 */
class WorkflowStateStorage extends ConfigEntityStorage {
